...
function test_no_index_results_in_table_scan {
    ...
    /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Forever21! -d exploration -i ./sql/create-table-without-index.sql
    /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Forever21! -d exploration -i ./sql/insert.sql    
    /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Forever21! -d exploration -i ./sql/select-for-plan.sql > ./demo/actual-without-index
...
function test_index_results_in_index_seek {
    ...
    /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Forever21! -d exploration -i ./sql/insert.sql    
    /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Forever21! -d exploration -i ./sql/select-for-plan.sql > ./demo/actual-with-index
